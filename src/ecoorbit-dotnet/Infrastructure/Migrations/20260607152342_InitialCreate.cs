        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    REGION = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
                    ...
                    CAPTURED_AT = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    SUBMITTED_AT = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    FIRE_DETECTED = table.Column<int>(type: "NUMBER(1)", nullable: false),
                    RISK_LEVEL = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CONFIDENCE_SCORE = table.Column<double>(type: "BINARY_DOUBLE", nullable: false),
                    NOTES = table.Column<string>(type: "NVARCHAR2(1000)", maxLength: 1000, nullable: false),
                    ANALYZED_AT = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    SATELLITE_IMAGE_ID = table.Column<Guid>(type: "RAW(16)", nullable: false)
                },
                constraints: table =>
                {
